 ...
 */
public class CCustomerSaleStatReportWindow extends CBaseQueryWindow
{
    private JDataTableComboBox customerField;
    private JDataDatePicker beginDateField;
    private JDataDatePicker endDateField;

    public CCustomerSaleStatReportWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        vo.setStatus(1);
        if(this.customerField.getText() != null && !this.customerField.getText().equals(""))
        {
            vo.setSupplier((Customer)this.customerField.getSelectedItem());
        }
...
//        vo.setWay(1);
        List<SaleDetailPo> SaleOrderPos =saleService.findSaleCustomerProductDaetails(vo);
    ...
    protected CPanel getMainPanel()
    {
        ...
        customerField = new JDataTableComboBox("", Customer.class,this.dataSource,Main.getMainFrame().getObjectsPool().getCustomerTable() , "name");
