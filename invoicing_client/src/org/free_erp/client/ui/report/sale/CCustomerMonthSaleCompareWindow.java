 ...
 */
public class CCustomerMonthSaleCompareWindow extends CBaseQueryWindow
{
    private JDataField catalogNameField;
    private JDataField yearField;

    public CCustomerMonthSaleCompareWindow(String title)
    {
        super(title);
    }
    ...
    protected CPanel getMainPanel()
    {
        ...
        catalogNameField =  new JDataField();
        int x = 60;
        int y = 10;
