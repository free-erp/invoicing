 ...
 * @author tzl
 */
public class CSaleIndentProductQueryWindow extends CBaseQueryWindow
{
    private JDataComboBox catalogNameField;
    private JDataPanelComboBox numberField;
    private JDataTableComboBox supplierField,adminField;
    private JDataDatePicker beginDateField;
    private JDataDatePicker endDateField;

    public CSaleIndentProductQueryWindow(String title)
    {
        super(title);
    }
...
//        }
        ...
        List<SaleOrderDetailPo> SaleOrderPos =saleService.findSaleOrderDetails(vo);
...
//
//        	column = new JDataTableColumn();
//		column.setHeaderText("余额数量");
//		column.setColumnName("notAccount");
//		column.setWidth(80);
//		columnModel.addColumn(column);
//
//		column = new JDataTableColumn();
//		column.setHeaderText("余额金额");
//		column.setColumnName("notTotalMoney");
//		column.setWidth(100);
//        column.setValueType(Currency.class);
//		columnModel.addColumn(column);
//        	column = new JDataTableColumn();
//		column.setHeaderText("销售数量");
//		column.setColumnName("clinchAccount");
//		column.setWidth(80);
//		columnModel.addColumn(column);
//
//		column = new JDataTableColumn();
//		column.setHeaderText("销售金额");
//		column.setColumnName("clinchTotalMoney");
//		column.setWidth(100);
//        column.setValueType(Currency.class);
//		columnModel.addColumn(column);
    }
