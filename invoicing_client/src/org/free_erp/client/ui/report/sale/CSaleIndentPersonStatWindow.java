 ...
 * @author tzl
 */
public class CSaleIndentPersonStatWindow extends CBaseQueryWindow
{
    ...
    public CSaleIndentPersonStatWindow(String title)
    {
        super(title);
    }
...
//        vo.setWay(1);
        List<SaleOrderDetailPo> SaleOrderPos =saleService.findSaleOrderEmployeeProductDaetails(vo);
