 ...
 */
public class CSaleIndentBalanceQueryWindow extends CBaseQueryWindow
{
    ...
    public CSaleIndentBalanceQueryWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        List<SaleOrderDetailPo> SaleOrderPos =saleService.findSaleBalance(vo);
        SaleOrderPos.get(0).getAmount();
    ...
    protected void initColumns()
    {
        ...
        column.setColumnName("mainObject.customer");
        column.setWidth(140);
        columnModel.addColumn(column);
        column = new JDataTableColumn();
        column.setHeaderText("业务员名称");
        column.setColumnName("mainObject.employee");
        column.setWidth(80);
        columnModel.addColumn(column);
       column = new JDataTableColumn();
