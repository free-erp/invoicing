 ...
 */
public class CSaleIndentProductStatWindow extends CBaseQueryWindow
{
    ...
    public CSaleIndentProductStatWindow(String title)
    {
        super(title);
    }
...
//        this.catalogNameField.setSelectedItem("");
    ...
    protected void select()
    {
        ...
        List<SaleOrderDetailPo> SaleOrderPos =saleService.findSaleOrderProductDaetails(vo);
...
//        column = new JDataTableColumn();
    ...
    protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(Main.getMainFrame(), this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/sale/rSaleIndentProductStats.jasper"),variables, this.dataSource.getDataRows());
