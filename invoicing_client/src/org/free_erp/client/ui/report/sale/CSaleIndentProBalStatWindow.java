 ...
 * @author tzl
 */
public class CSaleIndentProBalStatWindow extends CBaseQueryWindow
{
    ...
    public CSaleIndentProBalStatWindow(String title)
    {
        super(title);
    }
...
//        }
        ...
        List<SaleProductStatPo> SaleOrderPos =saleService.findSaleProductBalanceDaetails(vo);
        if(SaleOrderPos == null || SaleOrderPos.size() == 0)
        {
            this.clearInfo();
        }
        for(SaleProductStatPo po : SaleOrderPos)
        {
