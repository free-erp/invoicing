 ...
 */
public class CCustomerSaleDetailQueryWindow  extends CBaseQueryWindow
{
    ...
    public CCustomerSaleDetailQueryWindow(String title)
    {
        super(title);
    }
...
//        }
        ...
        System .out.println(SaleOrderPos.size());
