 ...
 */
public class CProductSaleStatReportWindow extends CBaseQueryWindow
{
   ...
   private JDataTableComboBox supplierField;
    ...
    public CProductSaleStatReportWindow(String title)
    {
        super(title);
    }
...
//        vo.setWay(1);
        List<SaleDetailPo> SaleOrderPos =saleService.findSaleProductDaetails(vo);
