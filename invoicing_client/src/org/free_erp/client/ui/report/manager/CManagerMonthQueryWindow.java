...
public class CManagerMonthQueryWindow extends CBaseQueryWindow
{
    ...
    protected void select()
    {
        ...
        List<DailyReportPo> DailyReportPos =managerService.getManagerMonthForm(vo);
    ...
    protected void doPrint()
    {
        ...
        vo.setImage(image);
        vo.setTitle("总经理月报表查询");
        variables = ReportUtilities.creatParameterMap(vo);
        CPrintDialog printDialog = new CPrintDialog(Main.getMainFrame(), this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/rManagerMonth.jasper"),variables, this.dataSource.getDataRows());
