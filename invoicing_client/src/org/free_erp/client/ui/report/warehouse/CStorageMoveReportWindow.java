 ...
 */
public class CStorageMoveReportWindow extends CBaseQueryWindow implements ActionListener
{
    ...
    public CStorageMoveReportWindow(String title)
    {
        super(title);
    }
    ...
    protected CPanel getMainPanel() {
        ...
        topPanel.addComponent(endDateField, x + 170, y, 120, 20, "至", 20);
    ...
    protected void select()
    {
        ...
        List<MoveStorageDetailPo> moveStorageDetailPoS = storageService.findMoveStorageDetails(vo);
        
        for(MoveStorageDetailPo po:moveStorageDetailPoS)
		{
			IDataRow dataRow = new ObjectDataRow(po, "id", null);
			model.insertDataRow(dataRow);
		}
        if(moveStorageDetailPoS == null || moveStorageDetailPoS.size() == 0)
        {
            this.clearInfo();
        }
    }
