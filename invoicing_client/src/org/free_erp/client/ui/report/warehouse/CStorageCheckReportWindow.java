 ...
 */
public class CStorageCheckReportWindow extends CBaseQueryWindow implements ActionListener {
    ...
    public CStorageCheckReportWindow(String title) {
        super(title);
    }
    ...
    protected void select() {
        ...
        List<CheckStorageDetailPo> checkStorageDetailPos = storageService.findCheckStorageDetails(vo);
        
        for (CheckStorageDetailPo po : checkStorageDetailPos) {
