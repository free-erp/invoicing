...
import org.free_erp.client.ui.forms.warehouse.CStorageOutflowDetailDialog;
 ...
 * @Changer  TENGZHUOLIN
 */
public class CStorageOutflowQueryWindow extends CBaseQueryWindow  {
    ...
    public CStorageOutflowQueryWindow(String title)
    {
        super(title);
        initComps();
    }
   ...
   protected void initColumns()
   {
    ...
    protected CPanel getMainPanel() {
        ...
        panel.addComponent(chargePerson, x + 170, y, 100, 20, "保管员", 50);
    ...
    protected void select()
    {
        ...
        List<OutflowStoragePo> OutflowStoragePos = storageService.findOutflowStorageForms(vo);
        
		for(OutflowStoragePo po:OutflowStoragePos)
		{
			IDataRow dataRow = new ObjectDataRow(po, "id", null);
			model.insertDataRow(dataRow);
		}
        if(OutflowStoragePos == null || OutflowStoragePos.size() == 0)
        {
            this.clearInfo();
        }
    }
    ...
    protected void doShowDetail()
    {
        ...
        CStorageOutflowDetailDialog formDialog = new CStorageOutflowDetailDialog(Main.getMainFrame(), this.dataSource, null);
