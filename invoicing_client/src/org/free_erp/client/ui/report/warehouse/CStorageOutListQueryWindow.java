 ...
 */
public class CStorageOutListQueryWindow extends CBaseQueryWindow implements ActionListener
{
    ...
    public CStorageOutListQueryWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        List<OutStorageDetailPo> outStorageDetailPos = storageService.findOutStorageDetails(vo);
        
        for(OutStorageDetailPo po:outStorageDetailPos)
		{
			IDataRow dataRow = new ObjectDataRow(po, "id", null);
			model.insertDataRow(dataRow);
		}
        if(outStorageDetailPos == null || outStorageDetailPos.size() == 0)
        {
            this.clearInfo();
        }
    }
