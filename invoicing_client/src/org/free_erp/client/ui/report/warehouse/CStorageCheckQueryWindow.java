...
import org.free_erp.client.ui.forms.warehouse.CStorageCheckDetailDialog;
 ...
 * @Changer  TENGZHUOLIN
 */
public class CStorageCheckQueryWindow extends CBaseQueryWindow  {
    ...
    public CStorageCheckQueryWindow(String title)
    {
        super(title);
        initComps();
    }
   ...
   protected void initColumns()
   {
    ...
    protected void doShowDetail()
    {
        ...
        CStorageCheckDetailDialog formDialog = new CStorageCheckDetailDialog(Main.getMainFrame(), this.dataSource, null);
