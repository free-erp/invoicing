 ...
 */
public class CStorageOutflowReportWindow extends CBaseQueryWindow implements ActionListener
{
    ...
    public CStorageOutflowReportWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        List<OutflowStorageDetailPo> outflowStorageDetailPos = storageService.findOutflowStorageDetails(vo);
        
        for(OutflowStorageDetailPo po:outflowStorageDetailPos)
		{
