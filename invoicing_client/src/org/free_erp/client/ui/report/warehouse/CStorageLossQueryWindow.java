...
import org.free_erp.client.ui.forms.warehouse.CStorageLossDetailDialog;
 ...
 * @Changer  TENGZHUOLIN
 */
public class CStorageLossQueryWindow extends CBaseQueryWindow  {
    ...
    public CStorageLossQueryWindow(String title)
    {
        super(title);
        initComps();
    }
   ...
   protected void initColumns()
   {
    ...
    protected void select()
    {
        ...
        List<LossStoragePo> lossStoragePos = storageService.findLossStorageForms(vo);
        
		for(LossStoragePo po:lossStoragePos)
		{
			IDataRow dataRow = new ObjectDataRow(po, "id", null);
			model.insertDataRow(dataRow);
		}
        if(lossStoragePos == null || lossStoragePos.size() == 0)
        {
            this.clearInfo();
        }
    }
    ...
    protected void doShowDetail()
    {
        ...
        CStorageLossDetailDialog formDialog = new CStorageLossDetailDialog(Main.getMainFrame(), this.dataSource, null);
