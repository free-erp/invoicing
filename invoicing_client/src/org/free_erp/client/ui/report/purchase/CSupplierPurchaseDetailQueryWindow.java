 ...
 */
public class CSupplierPurchaseDetailQueryWindow extends CBaseQueryWindow
{
    ...
    public CSupplierPurchaseDetailQueryWindow(String title)
    {
        super(title);
    }
	...
	protected void doPrint()
    {
        ...
        vo.setImage(image);
        vo.setTitle("供应商采购明细查询报表");
        variables = ReportUtilities.creatParameterMap(vo);
        CPrintDialog printDialog = new CPrintDialog(Main.getMainFrame(), this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/purchase/rSupplierPurchaseDetail.jasper"),variables, this.dataSource.getDataRows());
