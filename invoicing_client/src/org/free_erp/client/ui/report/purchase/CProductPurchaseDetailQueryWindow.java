...
public class CProductPurchaseDetailQueryWindow extends CBaseQueryWindow
{
    ...
    protected CPanel getMainPanel()
    {
        ...
        panel.addComponent(adminField, x + 170, y, 120, 20, "业务员", 50);
        panel.addComponent(numberField, x + 340, y, 100, 20, "商品编号", 50);
        //panel.addComponent(catalogNameField, x , y + 25, 100, 20, "商品分类", 50);
        //panel.addComponent(beginDateField, x + 170 , y + 25, 120, 20, "查询时间", 50);
        //panel.addComponent(endDateField, x + 320, y + 25, 100, 20, "至", 50);
        panel.addComponent(beginDateField, x , y + 25, 120, 20, "查询时间", 50);
        panel.addComponent(endDateField, x + 170 , y + 25, 120, 20, "至", 50);
