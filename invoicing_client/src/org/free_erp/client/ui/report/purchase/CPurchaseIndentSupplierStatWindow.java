 ...
 */
public class CPurchaseIndentSupplierStatWindow extends CBaseQueryWindow
{
    ...
    public CPurchaseIndentSupplierStatWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        List<PurchaseIndentProductPo> pos = purchaseService.findPurchaseIndentSupplierStat(vo);
    ...
    protected CPanel getMainPanel()
    {
        ...
        panel.addComponent(supplierField, x, y, 120, 20, "供应商", 40);
	...
	protected void doPrint()
    {
        ...
        vo.setImage(image);
        vo.setTitle("采购订单供应商统计报表");
        variables = ReportUtilities.creatParameterMap(vo);
        CPrintDialog printDialog = new CPrintDialog(Main.getMainFrame(), this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/purchase/rPurchaseIndentSupplierStat.jasper"),variables, this.dataSource.getDataRows());
