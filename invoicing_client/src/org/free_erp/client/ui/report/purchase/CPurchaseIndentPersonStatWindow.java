 ...
 */
public class CPurchaseIndentPersonStatWindow extends CBaseQueryWindow
{
    ...
    public CPurchaseIndentPersonStatWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        List<PurchaseIndentProductPo> pos = purchaseService.findPurchaseIndentPersonStat(vo);
	...
	protected void doPrint()
    {
        ...
        vo.setImage(image);
        vo.setTitle("采购订单业务员统计报表");
        variables = ReportUtilities.creatParameterMap(vo);
        CPrintDialog printDialog = new CPrintDialog(Main.getMainFrame(), this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/purchase/rPurchaseIndentPersonStat.jasper"),variables, this.dataSource.getDataRows());
