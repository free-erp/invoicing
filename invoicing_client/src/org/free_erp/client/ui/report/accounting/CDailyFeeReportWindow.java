 ...
 */
public class CDailyFeeReportWindow extends CCashBankMonthReportWindow
{
    public CDailyFeeReportWindow(String title)
    {
        super(title);
    }
    ...
    protected void select()
    {
        ...
        for(Subject subject:subjects)
        {
            ...
            if (id != ServiceConstants.SUBJECT_CATALOG_BUSSINESS_EXPENSE &&
                id != ServiceConstants.SUBJECT_CATALOG_COMMON_EXPENSE)
            {
                continue;
            }
