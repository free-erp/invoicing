 ...
 * @author afa
 */
public class CCommonExpenseDialog extends CBaseAccountingMainDetailDialog
{
	...
	public CCommonExpenseDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        initCs();
	}
	
	public CCommonExpenseDialog(Frame parent, IDbSupport dbSupport)
	{
...
//        departmentField = new JDataComboBox("department", String.class, this.dataSource);
    ...
    protected CPanel getBottomPane()
    {
        ...
        bPanel.addComponent(payMoney, x + 270, y, 200, 20, "付款金额", 60);
    ...
    {
        CTableComboBox comboBox = new CTableComboBox(Main.getMainFrame().getObjectsPool().getCommonExpenseSubjectTable(), "number");//temp
    ...
    protected Class getDetailClass() {
        return CommonExpenseDetail.class;
    }
	...
	{
        CommonExpense po = new CommonExpense();
    ...
    protected void updateTotalMoney() {
        ...
        this.payMoney.setText(String.valueOf(money));
    }
