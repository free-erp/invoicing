 ...
 * @author afa
 */
public class CPrePayableManageWindow extends CBaseAccountListWindow
{
	public CPrePayableManageWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<Prepayable> pos = service.getAllPrepayableForms(Main.getMainFrame().getCompany());
		List<IDataRow> dataRows = new ArrayList<IDataRow>();
        for(Prepayable po:pos)
		{
    ...
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<Prepayable> pos = service.findPrepayableForms(vo);
    ...
    protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CPrePayableDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
	...
	protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/PrePayableManage.jasper"),variables, this.dataSource.getDataRows());
