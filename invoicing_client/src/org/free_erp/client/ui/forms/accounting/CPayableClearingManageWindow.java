 ...
 * @author afa
 */
public class CPayableClearingManageWindow extends CBaseAccountListWindow
{
	public CPayableClearingManageWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
       IAccountingService service = Main.getServiceManager().getAccountingService();
		List<PayableClearing> pos = service.getAllPayableClearingForms(Main.getMainFrame().getCompany());
    ...
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<PayableClearing> pos = service.findPayableClearingForms(vo);
    ...
    protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CPayableClearingDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
   ...
   @Override
    protected void doAdd()
    {
        this.allStatusButton.setSelected(true);
        this.doFilter();
        CPayableClearingDialog cDialog = (CPayableClearingDialog)formDialog;
        CPayableSelectDialog selectDialog = new CPayableSelectDialog(Main.getMainFrame());
        selectDialog.setVisible(true);
        this.formDialog.newDataRow();
        cDialog.setCustomer(selectDialog.getCustomer());
        cDialog.setPayables(selectDialog.getDetailObjects());
	...
	protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/PayableClearingManage.jasper"),variables, this.dataSource.getDataRows());
