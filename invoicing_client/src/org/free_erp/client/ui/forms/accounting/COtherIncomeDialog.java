 ...
 * @author afa
 */
public class COtherIncomeDialog extends CBaseAccountingMainDetailDialog implements ValueChangedListener
{
	...
	public COtherIncomeDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        initCs();
	}
	
	public COtherIncomeDialog(Frame parent, IDbSupport dbSupport)
	{
...
//        departmentField = new JDataComboBox("department", String.class, this.dataSource);
    ...
    protected CPanel getBottomPane()
    {
        ...
        //payAccountField.setRequired("收款帐号", true);
        ...
        bPanel.addComponent(payAccountField, x + 180, y, 160, 20, "收款帐号", 60);
    ...
    {
        CTableComboBox comboBox = new CTableComboBox(Main.getMainFrame().getObjectsPool().getOtherIncomeSubjectTable(), "number");//temp
    ...
    protected Class getDetailClass() {
        return OtherIncomeDetail.class;
    }
	...
	{
        OtherIncome po = new OtherIncome();
    ...
    private void refreshPayMoney()
    {
        if (this.payAccountField.getSelectedItem() != null)
        {
            ...
            this.receiveMoney.setText(String.valueOf(this.totailMoney.getMoney()));
        }
    }
    ...
    protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/OtherIncomeDetail.jasper"),variables, this.table.getDataSource().getDataRows());
