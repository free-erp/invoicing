 ...
 * @author afa
 */
public class CReceivableClearingManageWindow  extends CBaseAccountListWindow
{
	public CReceivableClearingManageWindow(String title)
	{
		super(title);
	...
	protected void initTableColumns()
	{
		...
		column.setColumnName("affordType.name");
        column.setWidth(60);
		columnModel.addColumn(column);
	...
	private void initDatas()
	{
		...
		List<ReceivableClearing> pos = service.getAllReceivableClearingForms(Main.getMainFrame().getCompany());
    ...
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<ReceivableClearing> pos = service.findReceivableClearingForms(vo);
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CReceivableClearingDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    ...
    protected void doAdd()
    {
        this.allStatusButton.setSelected(true);
        this.doFilter();
        CReceivableClearingDialog cDialog = (CReceivableClearingDialog)formDialog;
        CReceivableSelectDialog selectDialog = new CReceivableSelectDialog(Main.getMainFrame());
        selectDialog.setVisible(true);
        this.formDialog.newDataRow();
        cDialog.setCustomer(selectDialog.getCustomer());
        cDialog.setReceivables(selectDialog.getDetailObjects());
	...
	protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/ReceivableClearingManage.jasper"),variables, this.dataSource.getDataRows());
