 ...
 * @author afa
 */
public class CBussinessExpenseManageWindow extends CBaseAccountListWindow
{
	public CBussinessExpenseManageWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<BussinessExpense> pos = service.getAllBussinessExpenseForms(Main.getMainFrame().getCompany());
    ...
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<BussinessExpense> pos = service.findBussinessExpenseForms(vo);
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CBussinessExpenseDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
