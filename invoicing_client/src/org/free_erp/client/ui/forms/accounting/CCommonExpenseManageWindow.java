 ...
 * @author afa
 */
public class CCommonExpenseManageWindow extends CBaseAccountListWindow
{
	public CCommonExpenseManageWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<CommonExpense> pos = service.getAllCommonExpenseForms(Main.getMainFrame().getCompany());
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CCommonExpenseDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
