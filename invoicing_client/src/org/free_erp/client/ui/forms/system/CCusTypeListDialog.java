 ...
 */
public class CCusTypeListDialog extends CBaseListManageDialog
{
    protected CCusTypeAddDialog dialog;
    public CCusTypeListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("客户类型名称");
		column.setColumnName("cusType");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<CustomerType> customerTypes = service.getListCustomerTypes(Main.getMainFrame().getCompany());
		for(CustomerType po:customerTypes)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CCusTypeAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加客户类型");
    ...
    public void createDbSupport()
    {
		dbSupport = new IDbSupport()
        {
			...
			public void save(Object obj)
            {
                ...
                {
					throw new IllegalArgumentException("00参数类型不符合!传入的类型为" + obj.getClass().getName());
				}
			}
