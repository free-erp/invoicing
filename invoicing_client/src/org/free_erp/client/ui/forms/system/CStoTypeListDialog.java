 ...
 */
public class CStoTypeListDialog extends CBaseListManageDialog
{
    protected CStoTypeAddDialog dialog;
    public CStoTypeListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("仓库类型名称");
		column.setColumnName("stoType");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<StorageType> storageTypes = service.getListStorageTypes(Main.getMainFrame().getCompany());
		for(StorageType po:storageTypes)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CStoTypeAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加仓库类型");
