 ...
 */
public class CProUnitListDialog extends CBaseListManageDialog
{
    protected CProUnitAddDialog dialog;
    public CProUnitListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("商品单位名称");
		column.setColumnName("proUnit");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<ProductUnit> productUnits = service.getListProductUnits(Main.getMainFrame().getCompany());
		for(ProductUnit po:productUnits)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CProUnitAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加商品单位");
