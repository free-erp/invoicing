 ...
 */
public class CEmpLevelListDialog extends CBaseListManageDialog
{
    protected CEmpLevelAddDialog dialog;
    public CEmpLevelListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("学历名称");
		column.setColumnName("empLevel");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<EmployeeLevel> employeeLevels = service.getListEmployeeLevels(Main.getMainFrame().getCompany());
		for(EmployeeLevel po:employeeLevels)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CEmpLevelAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加员工文化程度");
