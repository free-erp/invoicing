 ...
 */
public class CEmpHealthListDialog extends CBaseListManageDialog
{
    protected CEmpHealthAddDialog dialog;
    public CEmpHealthListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("健康状况名称");
		column.setColumnName("empHealth");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<EmployeeHealth> employeeHealths = service.getListEmployeeHealths(Main.getMainFrame().getCompany());
		for(EmployeeHealth po:employeeHealths)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CEmpHealthAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加健康状况");
