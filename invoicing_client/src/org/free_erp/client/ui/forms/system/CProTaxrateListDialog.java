 ...
 */
public class CProTaxrateListDialog extends CBaseListManageDialog
{
    protected CProTaxrateAddDialog dialog;
    public CProTaxrateListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("商品税率");
		column.setColumnName("proTaxrate");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<ProductTaxrate> productTaxrates = service.getListProductTaxrates(Main.getMainFrame().getCompany());
		for(ProductTaxrate po:productTaxrates)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CProTaxrateAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
        dialog.setTitle("添加商品税率");
