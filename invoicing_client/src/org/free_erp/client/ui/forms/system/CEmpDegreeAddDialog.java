...
public class CEmpDegreeAddDialog extends CBaseListDetailedDialog implements ActionListener
{
    ...
    protected CPanel getMainPanel()
    {
        ...
        this.addField.setRequired("员工职称", true);
        this.addField.setMaxLength(30);
        panel.addComponent(this.addField, 70, 5, 100, 20, "员工职称：", 60);
        return panel;
    }
    ...
    protected boolean isExist()
    {
        for(int i=0;i<this.dataSource.getDataRows().size();i++)
        {
            ...
            if(empDegree != null)
            {
                ...
                {
                    MessageBox.showMessageDialog(this, "“" + empDegree +"”已经存在！");
                    return true;
                }
            }
        }
