 ...
 */
public class CCusInvoiceListDialog extends CBaseListManageDialog
{
    protected CCusInvoiceAddDialog dialog;
    public CCusInvoiceListDialog(Frame parent)
    {
        super(parent);
    ...
    protected void initColumns()
    {
		...
		column.setHeaderText("发票类型名称");
		column.setColumnName("cusInvoice");
		column.setWidth(165);
    ...
    public void initDatas()
    {
		...
		List<CustomerInvoice> customerInvoices = service.getCustomerInvoices(Main.getMainFrame().getCompany());
		for(CustomerInvoice po:customerInvoices)
		{
    ...
    public void doAdd()
    {
        if (this.dialog == null)
		{
			this.dialog = new CCusInvoiceAddDialog(this, this.dataSource);
		}
		dialog.newDataRow();
