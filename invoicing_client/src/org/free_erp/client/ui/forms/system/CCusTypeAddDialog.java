 ...
 */
public class CCusTypeAddDialog extends CBaseListDetailedDialog implements ActionListener
{
    public JDataField addField;
    public CCusTypeAddDialog(JDialog parent, IDataSource dataSource)
    {
        super(parent ,dataSource);
        this.setTitle("添加客户类型");
    ...
    protected CPanel getMainPanel()
    {
        ...
        this.addField = new JDataField("cusType", String.class, dataSource);
        this.addField.setRequired("客户类型", true);
        this.addField.setMaxLength(30);
        panel.addComponent(this.addField, 70, 5, 100, 20, "客户类型：", 60);
        return panel;
    }
    ...
    protected boolean isExist()
    {
        ...
        {
            String cusType = (String)this.dataSource.getDataRows().get(i).getColumnValue("cusType");
            if(cusType != null)
            {
                if(cusType.equals(this.addField.getText()))
                {
                    MessageBox.showMessageDialog(this, "“" + cusType +"”已经存在！");
                    return true;
                }
            }
        }
    ...
    public void newDataRow()
    {
		...
		customerType.setCompany(Main.getMainFrame().getCompany());
		IDataRow dataRow = ObjectDataRow.newDataRow(customerType, "id", this.dbSupport);
    ...
    public void createDbSupport()
    {
		dbSupport = new IDbSupport()
        {
			...
			public void delete(Object obj)
            {
                ...
                {
					CustomerType po = (CustomerType) obj;
					optionSetService.deleteCustomerType(po);
					pool.refreshCustomerTypes();
				}
                else
                {
			...
			public void save(Object obj)
            {
                ...
                {
					CustomerType po = (CustomerType) obj;
					optionSetService.saveCustomerType(po);
					pool.refreshCustomerTypes();
				}
                else
                {
