 ...
 */
public class CPurchaseOrderDialog extends CBasePurchaseMainDetailDialog
{
    //临时
    protected JDataField defaultPriceField;

    public CPurchaseOrderDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("采购单");
	}
    
    public CPurchaseOrderDialog(Frame parent, IDbSupport dbSupport)
	{
...
//		columnModel.addColumn(column);
    ...
    {
        return PurchaseOrderDetailPo.class;
    }

    @Override
    public CBasePurchaseProductDialog getNewProductSelectDialog()
    {
        return new CPurchaseOrderProductDialog(this, this.table.getDataSource(), this.getStorage());
    }
