 ...
 */
public class CPurchaseChangeOrderWindow extends CBasePurchaseListWindow
{
    public CPurchaseChangeOrderWindow(String title)
	{
		super(title);
    ...
    private void initDatas()
	{
		...
		List<PurchaseIndentPo> purchaseIndentPos = purchaseService.getAllPurchaseIndentPoForms(Main.getMainFrame().getCompany());
    ...
    protected void removeNumberLog()
    {
        ...
        systemLog.setContent("删除采购订单-编号:" + this.removeNumber);
    ...
    protected CBaseFormDialog getFormDialog()
    {
        if (formDialog == null)
        {
            formDialog =  new CPurchaseChangeOrderDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
    }
    @Override
    ...
    {
        return new CChooseIndentDialog(this, this.dataSource, dbSupport);
    }
