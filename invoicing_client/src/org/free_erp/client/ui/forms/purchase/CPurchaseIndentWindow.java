 ...
 */
public class CPurchaseIndentWindow extends CBasePurchaseListWindow
{
    public CPurchaseIndentWindow(String title)
	{
		super(title);
    ...
    protected CBaseFormDialog getFormDialog()
    {
        if (formDialog == null)
        {
            formDialog =  new CPurchaseIndentDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
    }
