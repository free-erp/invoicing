 ...
 */
public class CPurchaseIndentDialog extends CBasePurchaseMainDetailDialog
{
    //临时
    protected JDataField defaultPriceField;
    
    public CPurchaseIndentDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("采购订单");
	}
    
    public CPurchaseIndentDialog(Frame parent, IDbSupport dbSupport)
	{
    ...
    {
        return PurchaseIndentDetailPo.class;
    }
