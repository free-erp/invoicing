 ...
 */
public class CChoosepurchaseOrderChangeDialog extends JDataDialog implements ActionListener
{
    ...
    public CChoosepurchaseOrderChangeDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
    {
...
//            this.dispose();
    ...
    protected CBaseFormDialog getFormDialog()
    {
        if (formDialog == null)
        {
            formDialog =  new CPurchaseChangeOrderDialog(Main.getMainFrame(), this.dataSource, dbSupport);
        }
