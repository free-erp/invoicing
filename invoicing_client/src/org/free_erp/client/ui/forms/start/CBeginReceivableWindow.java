...
public class CBeginReceivableWindow extends CBaseAccountListWindow
{
	public CBeginReceivableWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<InitialReceivable> pos = service.findAllInitialReceivableForms(Main.getMainFrame().getCompany());
		for(InitialReceivable po:pos)
		{
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CBeginReceivableDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    @Override
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<InitialReceivable> pos = service.findInitialReceivableForms(vo);
	...
	protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/BeginReceivable.jasper"),variables, this.dataSource.getDataRows());
