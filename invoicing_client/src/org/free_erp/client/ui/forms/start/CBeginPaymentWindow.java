...
public class CBeginPaymentWindow extends CBaseAccountListWindow
{
	public CBeginPaymentWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<InitialPayable> pos = service.findAllInitialPayableForms(Main.getMainFrame().getCompany());
		for(InitialPayable po:pos)
		{
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CBeginPaymentDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    @Override
    protected void doSearch()
    {
        ...
        IAccountingService service = Main.getServiceManager().getAccountingService();
        List<InitialPayable> pos = service.findInitialPayableForms(vo);
	...
	protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/BeginPayment.jasper"),variables, this.dataSource.getDataRows());
