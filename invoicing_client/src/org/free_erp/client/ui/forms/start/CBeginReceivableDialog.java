...
public class CBeginReceivableDialog extends CBaseFormDialog implements ValueChangedListener
{
    ...
    public CBeginReceivableDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
    {
    ...
    public CBeginReceivableDialog(Frame parent, IDbSupport dbSupport)
	{
		super(parent, new DefaultDataSource("id"), dbSupport);

        this.setTitle("应收期初单");
        this.setSize(930, 250);
            pagePane.setSize(900, 170);
	}

    @Override
    protected CPanel getMainPanel() {
        CPanel panel = new CPanel();
		panel.setPreferredSize(new Dimension(700, 210));
        ...
        employeeField.addValueChangedListener(this);
        ...
        moneyField = new JDataNumberField("receivableMoney", Double.class, this.dataSource);
        moneyField.setRequired("应收金额", true);
        ...
        y += ROW_SPAN;
        panel.addComponent(accountingMoney, x, y, 150, 20, "预收金额", 60);
         panel.addComponent(paymentTypeField, x + 220, y, 100, 20, "付款方式", 60);
        panel.addComponent(moneyField, x + 400, y, 100, 20, "应收金额", 60);
	...
	{
        InitialReceivable po = new InitialReceivable();
    ...
    protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/accounting/BeginReceivableDetail.jasper"),variables,this.dataSource.getCurrentDataRow());
