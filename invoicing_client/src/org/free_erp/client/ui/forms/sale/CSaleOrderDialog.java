...
public class CSaleOrderDialog  extends CBaseSaleMainDetailDialog
{
    ...
    public CSaleOrderDialog (Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("销售订单");
	}
    public CSaleOrderDialog(Frame parent, IDbSupport dbSupport)
	{
...
//		columnModel.addColumn(column);
    ...
    protected Class getDetailClass() {
       return SaleOrderDetailPo.class;
    }
