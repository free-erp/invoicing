 ...
 * @author tengzhuolin
 */
public class CSaleOrderWindow extends CBaseSaleListWindow
{
	public CSaleOrderWindow(String title)
	{
		super(title);
         
             this.chooseButton.setVisible(true);
        this.chooseButton.setText("选择报价单");
...
this.initDatas();
    ...
    protected void doPrint()
    {
     ...
     protected CBaseFormDialog getFormDialog()
	 {
        if (formDialog == null)
        {
            formDialog =  new CSaleOrderDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	 }
    ...
    {
       return new CSaleChooseOrderMoneyDialog(this, this.dataSource, dbSupport);
    }
