 ...
 * @author tengzhuolin
 */
public class CSaleChangeMoneyWindow extends CBaseSaleListWindow
{
	public CSaleChangeMoneyWindow(String title)
	{
		super(title);		
   ...
   private void initDatas() {
        ...
        List<SaleChangeMoneyPo> saleChangeMoneyPos = saleService.getAllSaleChangeMoneyForms(Main.getMainFrame().getCompany());
        for (SaleChangeMoneyPo po : saleChangeMoneyPos) {
   ...
   @Override
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CSaleChangeMoneyDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
