 ...
 */
public class CStorageMinMaxDetailDialog extends CBaseSelectDetailDialog
{
    ...
    public CStorageMinMaxDetailDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("库存上下限明细");
	}
    ...
    protected void doPrint()
    {
        ...
        vo.setTitle( "库存商品上下限明细报表");
        variables = ReportUtilities.creatParameterMap(vo);
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/rStorageMinMaxDetail.jasper"),variables, this.table.getDataSource().getDataRows());
