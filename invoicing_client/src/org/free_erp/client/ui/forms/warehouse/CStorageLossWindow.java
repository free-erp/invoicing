 ...
 */
public class CStorageLossWindow extends CBaseListWindow
{
	public CStorageLossWindow(String title)
	{
		super(title);
...
//		columnModel.addColumn(column);
	...
	private void initDatas()
	{
		...
		List<LossStoragePo> lossStoragePos = storageService.getAllLossStorageForms(Main.getMainFrame().getCompany());
     ...
     protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog =  new CStorageLossDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    ...
    protected void removeNumberLog()
    {
        ...
        systemLog.setContent("删除报损单-编号:" + this.removeNumber);
