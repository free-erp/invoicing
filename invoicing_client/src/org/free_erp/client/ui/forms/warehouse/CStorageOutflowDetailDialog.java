 ...
 */
public class CStorageOutflowDetailDialog extends CBaseSelectDetailDialog
{
    ...
    public CStorageOutflowDetailDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("库存报溢明细");
	}
