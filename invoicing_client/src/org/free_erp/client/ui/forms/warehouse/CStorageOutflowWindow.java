 ...
 * @Changer liufei
 */
public class CStorageOutflowWindow extends CBaseListWindow
{
	public CStorageOutflowWindow(String title)
	{
	       super(title);
...
//		columnModel.addColumn(column);
   ...
   private void initDatas()
  {
		...
		List<OutflowStoragePo> outflowStoragePo = storageService.getAllOutflowStorageForms(Main.getMainFrame().getCompany());
		for(OutflowStoragePo po:outflowStoragePo)
		{
	...
	protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog = new CStorageOutflowDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    ...
    protected void removeNumberLog()
    {
        ...
        systemLog.setContent("删除报溢单-编号:" + this.removeNumber);
