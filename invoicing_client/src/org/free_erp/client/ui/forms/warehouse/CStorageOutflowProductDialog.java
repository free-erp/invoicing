...
public class CStorageOutflowProductDialog extends CStorageOutProductDialog
{
    public CStorageOutflowProductDialog(JDialog parent, IDataSource dataSource, Storage storage)
    {
    ...
    protected void initC()
    {
        ...
        panel.addComponent(amountField, x + 300, y, 60, 20, "报溢数量", 50);
        panel.addComponent(totalMoneyField, x + 420, y, 100, 20, "报溢金额", 50);
        y += ROW_SPAN;
