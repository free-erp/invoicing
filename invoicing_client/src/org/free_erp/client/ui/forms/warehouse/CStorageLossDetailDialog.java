 ...
 */
public class CStorageLossDetailDialog extends CBaseSelectDetailDialog
{
    ...
    public CStorageLossDetailDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("库存报损明细");
	}
    ...
    protected void initColumns()
	{
		...
		column = new JDataTableColumn();
		column.setHeaderText("报损数量");
		column.setColumnName("amount");
		column.setWidth(80);
		columnModel.addColumn(column);

		column = new JDataTableColumn();
		column.setHeaderText("报损金额");
