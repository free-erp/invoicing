 ...
 */
public class CStorageOutWindow extends CBaseListWindow
{
	public CStorageOutWindow(String title)
	{
		super(title);
	...
	private void initDatas()
	{
		...
		List<OutStoragePo> outStoragePos = storageService.getAllOutStorageForms(Main.getMainFrame().getCompany());
    ...
    protected CBaseFormDialog getFormDialog()
	{
        if (formDialog == null)
        {
            formDialog = new CStorageOutDialog(this, this.dataSource, dbSupport);
        }
        return formDialog;
	}
    ...
    protected void removeNumberLog()
    {
        ...
        systemLog.setContent("删除出库单-编号:" + this.removeNumber);
