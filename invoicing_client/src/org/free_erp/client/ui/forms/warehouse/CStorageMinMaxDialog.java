 ...
 * @Changer liufei
 */
public class CStorageMinMaxDialog extends CBaseStorageMainDetailDialog
{
	protected JDataDatePicker inDateField;
	protected JDataField commentField;
    
	public CStorageMinMaxDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("上下限单");
	}
	
	public CStorageMinMaxDialog(Frame parent, IDbSupport dbSupport)
	{
...
//	}
	...
	{
		MinMaxStoragePo po = new MinMaxStoragePo();
    ...
    {
        return new CStorageMinMaxProductDialog(this, this.table.getDataSource(), this.getStorage());
    }
    @Override
  protected void doPrint()
    {
        ...
        CPrintDialog printDialog = new CPrintDialog(this, this.getClass().getResourceAsStream("/com/e68erp/demo/client/report/jaspers/StorageMaxMinDetail.jasper"),variables, this.table.getDataSource().getDataRows());
		printDialog.setVisible(true);
    }
	protected Class getDetailClass()
	{
		return MinMaxStorageDetailPo.class;
	}
}
