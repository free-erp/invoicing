 ...
 */
public class CStorageCheckDetailDialog extends CBaseSelectDetailDialog
{
    ...
    public CStorageCheckDetailDialog(Frame parent, IDataSource dataSource, IDbSupport dbSupport)
	{
		super(parent, dataSource, dbSupport);
        this.setTitle("仓库盘点明细");
	}
