 ...
 */
public class CStorageCheckProductDialog extends CStorageOutProductDialog
{
    public CStorageCheckProductDialog(JDialog parent, IDataSource dataSource, Storage storage)
    {
    ...
    protected void initC()
    {
        ...
        //amountField.setDisplayName("商品数量");
        ...
        panel.addComponent(amountField, x + 300, y, 60, 20, "实盘数量", 50);
        panel.addComponent(totalMoneyField, x + 420, y, 100, 20, "实盘金额", 50);
        y += ROW_SPAN;
