...
/**
 *本Entity记录客户在表单审核时候的信息
 * @author afa
 */
public class CustomerReceivementDetail implements java.io.Serializable {
    ...
    /**
     * 帐面上的应收款,不是payableMoney - clearingMoney
     */
	...
	/** default constructor */
	public CustomerReceivementDetail() {
	}
