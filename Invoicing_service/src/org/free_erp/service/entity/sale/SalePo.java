 ...
 */
public class SalePo extends ErpObject implements FormPo, java.io.Serializable {
    ...
    private Set<SaleDetailPo> details = new HashSet<SaleDetailPo>();
...
private String receivingCode;
   ...
   public SalePo()
   {
    ...
    public Set<SaleDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<SaleDetailPo> details) {
