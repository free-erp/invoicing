 ...
 * @author Administrator
 */
public class SaleChangeMoneyPo extends ErpObject implements FormPo, java.io.Serializable {
    ...
    private Set<SaleChangeMoneyDetailPo> details = new HashSet<SaleChangeMoneyDetailPo>();
    private Customer customer;
    private Employee employee;
    private Integer systemStatus = ServiceConstants.SYSTEM_STATUS;

    public SaleChangeMoneyPo()
    {
    ...
    public Set<SaleChangeMoneyDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<SaleChangeMoneyDetailPo> details) {
