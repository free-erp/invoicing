...
/**
 * AbstractMinMaxStorage entity provides the base persistence definition of the
 * MinMaxStorage entity.
 * @author TengJianfa mobile: 086-13003311398
 */

public class MinMaxStoragePo extends ErpObject  implements FormPo, java.io.Serializable
{
	...
	private Set<MinMaxStorageDetailPo> details = new HashSet<MinMaxStorageDetailPo>(0);

    public MinMaxStoragePo()
    {
        this.createDate = new Date();
    }

    public Set<MinMaxStorageDetailPo> getDetails() {
		return details;
	}
	public void setDetails(Set<MinMaxStorageDetailPo> details) {
