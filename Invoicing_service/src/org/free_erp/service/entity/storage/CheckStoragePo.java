...
/**
 * AbstractCheckStorage entity provides the base persistence definition of the
 * CheckStorage entity.
 * 
 * @author TengJianfa mobile: 086-13003311398
 */

public class CheckStoragePo extends ErpObject  implements FormPo, java.io.Serializable
{
	...
	private Set<CheckStorageDetailPo> details = new HashSet<CheckStorageDetailPo>(0);
    private Employee employee;
    
    public CheckStoragePo()
    {
	...
	public Set<CheckStorageDetailPo> getDetails() {
		return details;
	}
	public void setDetails(Set<CheckStorageDetailPo> details) {
