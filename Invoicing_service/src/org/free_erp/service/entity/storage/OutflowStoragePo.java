...
/**
 * AbstractOutflowStorage entity provides the base persistence definition of the
 * OutflowStorage entity.
 * 
 * @author TengJianfa mobile: 086-13003311398
 */

public  class OutflowStoragePo  extends ErpObject implements FormPo,java.io.Serializable
{
	...
	private Set<OutflowStorageDetailPo> details = new HashSet<OutflowStorageDetailPo>(0);
    private Storage storage;
	public Set<OutflowStorageDetailPo> getDetails() {
		return details;
	}
	public void setDetails(Set<OutflowStorageDetailPo> details) {
		this.details = details;
	}

    public OutflowStoragePo()
    {
