...
/**
 * AbstractInitialStorage entity provides the base persistence definition of the
 * InitialStorage entity.
 *
 * @author TengJianfa mobile: 086-13003311398
 */
public class InitialStoragePo extends ErpObject  implements FormPo, java.io.Serializable {//abstract
    ...
    private Set<InitialStorageDetailPo> details = new HashSet<InitialStorageDetailPo>();
    ...
    public Set<InitialStorageDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<InitialStorageDetailPo> details) {
