...
/**
 * AbstractLossStorage entity provides the base persistence definition of the
 * LossStorage entity.
 *
 * @author TengJianfa mobile: 086-13003311398
 */
public class LossStoragePo extends ErpObject  implements FormPo, java.io.Serializable {
    ...
    private Set<LossStorageDetailPo> details = new HashSet<LossStorageDetailPo>(0);
    private Employee employee;

    public LossStoragePo()
    {
	...
	public Set<LossStorageDetailPo> getDetails() {
		return details;
	}
	public void setDetails(Set<LossStorageDetailPo> details) {
