 ...
 */
public class PurchaseChangePo extends ErpObject implements FormPo, java.io.Serializable
{
    ...
    private Set<PurchaseChangeDetailPo> details = new HashSet<PurchaseChangeDetailPo>();
    ...
    private String operationType = "采购订单变更";

    public PurchaseChangePo()
    {
    ...
    public Set<PurchaseChangeDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<PurchaseChangeDetailPo> details) {
