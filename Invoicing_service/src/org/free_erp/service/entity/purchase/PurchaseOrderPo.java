 ...
 */
public class PurchaseOrderPo extends ErpObject implements FormPo, java.io.Serializable
{
    ...
    private Set<PurchaseOrderDetailPo> details = new HashSet<PurchaseOrderDetailPo>();
    private String defaultPrice;
    private AffordType payFashion;
    private ClearingType balanceFashion;
    private Integer payTerm = 30;
    private Integer indentPoID;
    private String operationType = "²É¹º";
    private Subject subject;
    private PurchaseIndentPo purchaseIndentPo;
    private Integer systemStatus = ServiceConstants.SYSTEM_STATUS;
    private Double offerMoney = 0d;

    public PurchaseOrderPo()
    {
    ...
    public PurchaseIndentPo getPurchaseIndentPo() {
        return purchaseIndentPo;
    }

    public void setPurchaseIndentPo(PurchaseIndentPo purchaseIndentPo) {
        this.purchaseIndentPo = purchaseIndentPo;
    }
    ...
    public Integer getIndentPoID() {
        return indentPoID;
    }

    public void setIndentPoID(Integer indentPoID) {
        this.indentPoID = indentPoID;
    }
    ...
    public Set<PurchaseOrderDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<PurchaseOrderDetailPo> details) {
