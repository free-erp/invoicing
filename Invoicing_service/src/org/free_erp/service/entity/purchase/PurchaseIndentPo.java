 ...
 */
public class PurchaseIndentPo extends ErpObject implements FormPo, java.io.Serializable
{
    ...
    public Set<PurchaseIndentDetailPo> getDetails() {
        return details;
    }

    public void setDetails(Set<PurchaseIndentDetailPo> details) {
